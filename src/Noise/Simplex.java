...
public class Simplex {
	...
	//main simplex generates one octave
	//best to combine multiple octaves
	
	// picked up this code from
    ...
    public Simplex(int largestFeature,double persistence, int seed){
        ...
        octaves=new MainSimplex[numberOfOctaves];
        ...
        for(int i=0;i<numberOfOctaves;i++){
            octaves[i]=new MainSimplex(rnd.nextInt());
